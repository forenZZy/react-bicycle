    ...
    render() {
        ...
        const guestNavBar = (
            <nav className="nav">
                ...
                <a href="#" className="nav-link"><img src={require("../../res/img/logo.png")} className="nav-logo"
                                                      alt="logo graphics"/></a>
        ...
        const guestMobNav = (
            <nav className="mobile-nav">
                ...
                <div className={this.state.isToggle ? 'mobile-nav-menu open' : 'mobile-nav-menu'}>
                    <Link to="/login" className="mobile-nav-link" onClick={this.handleClick}>Login</Link>
                    ...
                    <Link to="/register" className="mobile-nav-link" onClick={this.handleClick}>register</Link>
                </div>
            </nav>
        );
        ...
        const userMobNav = (
            <nav className="mobile-nav">
                ...
                <div className={this.state.isToggle ? 'mobile-nav-menu open' : 'mobile-nav-menu'}>
                    <Link to="/profile" className="mobile-nav-link" onClick={this.handleClick}>Profile</Link>
                    <a href="#" className="mobile-nav-link" onClick={this.handleClick}>Home</a>
                    <a href="#about" className="mobile-nav-link" onClick={this.handleClick}>About us</a>
                    <a href="#work" className="mobile-nav-link" onClick={this.handleClick}>Work</a>
                    <a href="#shop" className="mobile-nav-link" onClick={this.handleClick}>Shop</a>
                    <a href="#contact" className="mobile-nav-link" onClick={this.handleClick}>Contact</a>
                    <a href="" onClick={this.logOut.bind(this)} className="mobile-nav-link">Logout</a>
                </div>
            </nav>
        );
        ...
        return (
            <div className="header">
                ...
                {localStorage.usertoken ? userMobNav : guestMobNav}
            </div>
        )
    }
}
